...
const PAYLOADS: Record<RiskCopyPlacement, Record<RiskCopyVariant, RiskCopyPayload>> = {
  runtime_approval: {
    control: {
      hookLine: '免费版需要你逐次确认；完整版会更快同步规则并减少重复手动确认。',
      footerLine: '不点允许，这次操作就不会被放行',
      ctaLine: '升级完整版可获得更快规则更新与更少重复确认。',
    },
    anxiety: {
      hookLine:
        '免费版每次都要手动确认，漏看一次就可能放行高危动作；升级完整版可减少重复确认并优先下发新拦截规则。',
      footerLine: '只要你不点允许，这次高危动作就会继续被拦住。',
      ctaLine: '升级完整版后，规则更新更快，未知风险窗口更短。',
    },
  },
  rule_updates: {
    control: {
      hookLine: '免费版规则库延后更新，手动同步最短间隔为 7 天。',
      ctaLine: '升级完整版可开启自动热更新，减少未知威胁空窗期。',
    },
    anxiety: {
      hookLine: '免费版规则落后时，新出现的恶意 Skill / MCP 可能先一步执行高危动作。',
      ctaLine: '升级完整版后可实时更新规则，尽量缩短暴露窗口。',
    },
  },
};
