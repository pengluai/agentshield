...
const zhCN: Translations = {
  ...
  // Common
  welcome: 'AI 环境安全守护中',
  welcomeSubtitle: '深度扫描 AI 工具生态，一键检测并修复安全风险。',
  startScan: '扫描',
  stop: '停止',
  run: '运行',
  fixAll: '一键修复',
  ...
  lookingForThreats: '正在分析安全状态...',
  smartGuardScopedProtectionDetail: '监控 OpenClaw 和支持 MCP / Skill 的 AI 工具，敏感操作需你确认后放行',
  ...
  scanStepSystem: '检查后台活动...',

  // Security Scan
  securityScan: '安全扫描',
  securityScanDesc: '全面检查 AI 工具安全配置。',
  scanResults: '安全扫描结果',
  score: '评分',
  sortBy: '排序方式按',
  severity: '严重程度',
  ...
  // Upgrade Pro
  upgradePro: '升级 Pro',
  upgradeProSubtitle: '完整 23 项检测 · 一键修复 · 无限密钥存储',
...
const enUS: Translations = {
  ...
  // Common
  welcome: 'AI Environment Protected',
  welcomeSubtitle: 'Deep scan your AI tool ecosystem. Detect and fix security risks in one click.',
  startScan: 'Scan',
  stop: 'Stop',
  run: 'Run',
  fixAll: 'Fix All',
  ...
  lookingForThreats: 'Analyzing security status...',
  ...
  securityScanDesc: 'Comprehensive AI tool security check.',
  ...
  upgradeProSubtitle: 'Full 23-check scan · One-click fix · Unlimited key vault',
  ...
  proFeature3: 'Vulnerability detection & patching',
  proFeature4: 'Unlimited key storage',
  proFeature5: 'Advanced notifications & weekly report',
