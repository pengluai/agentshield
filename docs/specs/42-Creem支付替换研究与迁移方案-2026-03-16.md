...
1. Creem 是否适合当前项目
2. 如果接 Creem，代码应该怎么改
3. 是否要用 Creem 内建 Activation Codes
4. 第一阶段最小闭环怎么设计
...
- Activation Codes：<https://docs.creem.io/features/addons/licenses>
...
3. 先不切 Creem 原生 activation codes
4. 等商业闭环跑顺后，再评估是否第二阶段切 Creem 原生 license

### 5.2 为什么不建议第一阶段直接切 Creem 原生 Activation Codes

虽然 Creem 已经提供 built-in activation code API，但如果你第一阶段直接切，影响会扩大到：
...
- 决策：保留
- 备选：直接切 Creem 原生 activation codes
...
1. 评估是否切 Creem 原生 activation codes
